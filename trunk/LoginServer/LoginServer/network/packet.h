...
public:
	...
	// Копирует? строка ?переданный буфе??возвращает длин?
	...
	// Копирует? UNICODE строку ?буфе?для отпавк?паката
	...
	// Копирует? строку ?буфе?для отпавк?паката
	...
	//====================================================================================
	// Копирует? указанны?буфе??буфе?пакета для отпавк?паката
	//
